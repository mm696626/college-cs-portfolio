...
<?php
            ...
            $sql = "DELETE FROM appointment WHERE apptDate < (NOW() - INTERVAL 1 DAY)";
            ...
            //actually do appointment stuff now
            include 'connection.php'; // establish connection

            //get patients doctor
            $doctorID = 0;
            $sql = "SELECT doctor_iddoctor from patient where idpatient = " . $patientID;
            ...
            $sql = "CALL checkAppointment(" . $patientID . ", " . $doctorID . ", '" . $date . "')";
            ...
            if ($result) {
                echo "<p class='lead'> Thank you for the  request! You  have successfully made a doctor's appointment! See you then! :)</p>";

            }else {
                echo "<p class='lead'> Sorry, your appointment couldn't be made! Please try again! </p>";
                echo($conn -> error);
            }
